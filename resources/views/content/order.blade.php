    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <h2 class="card-title text-success">Ordenes</h2>
                    </div>          
                ...
                <div class="modal-body">
                        <div class="modal-body">
                            ...
                            <div class="md-form mb-3">
                                ...
                                <input  type="text" class="form-control" onkeyup="Mayus(this);" rows="4" id="presentacion" name="presentacion" placeholder="Presentacion" 
                                required> 
                                <div class="invalid-feedback">
                                    Dato necesario.
                                </div>
                            ...
                            <div class="md-form mb-3">
                                ...
                                <input  type="number" class="form-control" onkeyup="Mayus(this);" rows="4" id="precio" min="0" value="0" step="any" name="precio" placeholder="Precio" 
                                required> 
                                <div class="invalid-feedback">
                                    Dato necesario.
                                </div>
...
<script src="{{ URL::asset('js/scripts/orden.js') }}"></script>
@endsection