    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <h2 class="card-title text-primary">Rutinas</h2>
                    </div>
                ...
                <div class="modal-body">
                        <div class="modal-body">
                            ...
                            <div class="md-form mb-3">
                                ...
                                <input  type="text" class="form-control" onkeyup="Mayus(this);" rows="4" id="nombre_rutina" name="nombre_rutina" placeholder="Rutina" 
                                required> 
                            ...
                            <div class="md-form mb-3">
                                ...
                                <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                                    <input type="text" id="fecha" name="fecha" class="form-control datetimepicker-input" data-target="#datetimepicker1" required/>
